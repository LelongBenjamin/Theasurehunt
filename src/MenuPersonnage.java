...
public class MenuPersonnage {
	...
	public MenuPersonnage(int numEquipe, int taille) {
		...
		JButton explorateur = new JButton(new ImageIcon("ressource/EXPLORATEUR/Explorateur.png"));
		explorateur.setBounds(10, 40, 137, 200);
		explorateur.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(cpt < nbPerso){
					perso.add(new Personnage(Personnage.EXPLORATEUR, Personnage.FACE, pos_x, pos_y, numEquipe, new Joueur(pos_x, pos_y, null, null, numEquipe)));
					dessinEquipe();
					equipe.repaint();
					cpt++;
				}
		...
		JButton guerrie = new JButton(new ImageIcon("ressource/GUERRIER/Guerrier.png"));
		guerrie.setBounds(157, 40, 137, 200);
		guerrie.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(cpt < nbPerso){
					perso.add(new Personnage(Personnage.GUERRIER, Personnage.FACE, pos_x, pos_y, numEquipe, new Joueur(pos_x, pos_y, null, null, numEquipe)));
					dessinEquipe();
					equipe.repaint();
					cpt++;
				}
		...
		JButton voleur = new JButton(new ImageIcon("ressource/VOLEUR/Voleur.png"));
		voleur.setBounds(304, 40, 137, 200);
		voleur.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(cpt < nbPerso){
					perso.add(new Personnage(Personnage.VOLEUR, Personnage.FACE, pos_x, pos_y, numEquipe, new Joueur(pos_x, pos_y, null, null, numEquipe)));
					dessinEquipe();
					equipe.repaint();
					cpt++;
				}
		...
		JButton piegeur = new JButton(new ImageIcon("ressource/PIEGEUR/Piegeur.png"));
		piegeur.setBounds(451, 40, 137, 200);
		piegeur.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(cpt < nbPerso){
					perso.add(new Personnage(Personnage.PIEGEUR, Personnage.FACE, pos_x, pos_y, numEquipe, new Joueur(pos_x, pos_y, null, null, numEquipe)));
					dessinEquipe();
					equipe.repaint();
					cpt++;
				}
