...
public class Personnage extends Contenu{
	...
	int pos_x, pos_y, pos_x_bateau, pos_y_bateau, pm, pmInitiale, vie, vieMax, energie, energieMax, numEquipe;
	boolean cle, tresor, dansLeBateau, select ,mort;
/**
 * Creer personnage
 * 
 * @param typePerso
 ...
 */
	public Personnage(String typePerso, String oriantaion, int pos_x, int pos_y, int numEquipe, Joueur joueur) {
		...
		this.pos_x_bateau = joueur.posX_Bateau;
		this.pos_y_bateau = joueur.posY_Bateau;
	...
	/**
	 * Savoir si le personnage est dans le bateau
	 * @return vrai si le personnage est dans le bateau
	 */
	
	public boolean estDansBateau(){
		return (pos_x == pos_x_bateau) && (pos_y == pos_y_bateau); 
	}
}
